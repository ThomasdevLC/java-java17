...
//	BinaryOperator<Person> makeAChild = (Person f, Person m) -> {
//		return new Person(f.getFirstname() +" "+ m.getFirstname(), f.getLastname(), 0, null);
//	};
//	
	
	BinaryOperator<Person> makeAChild = (Person f, Person m) -> new Person(f.getFirstname() +" "+ m.getFirstname(), f.getLastname(), 0, null);
