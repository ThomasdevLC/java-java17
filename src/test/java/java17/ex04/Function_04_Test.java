...
public class Function_04_Test {
    ...
    // TODO AGE >=18
    Predicate<Person> adult = adult -> adult.getAge() >= 18;
    // end::adult[]
    ...
    public void test_predicate() throws Exception {
        ...
        List<Person> result = personList.stream().filter(adult).toList();
    ...
    Predicate<Person> lastnameIsFrance = name -> name.getLastname()=="France" ;


    // TODO compléter la fonction
    // TODO le prédicat vérifie que le prénom est "Armor"
    Predicate<Person> firstnameIsArmor = name -> name.getFirstname()=="Armor";
    // end::predicateand[]
    ...
    public void test_predicate_and() throws Exception {
        ...
        // TODO invoquer la méthode filter pour que le test soit passant
        // TODO chaîner les prédicats adult, lastnameIsFrance et lastnameIsFrance avec la méthode and
        List<Person> result = personList.stream().filter(adult).filter(lastnameIsFrance).filter (firstnameIsArmor ).toList();
